 ...
 */
package ch.zhaw.deeplearningjava.carclassification;
...
public final class Models {
    ...
    // the number of classification labels: all car brands
    public static final int NUM_OF_OUTPUT = 9;
    ...
    public static final String MODEL_NAME = "carclassifier";
